		...
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
			...
			<div class="space-y-5">
				...
				<div class="flex gap-3">
					<a href="https://x.com/oveprisiones" target="_blank" rel="noopener"
					...
					<a href="https://www.facebook.com/ObservatorioVenezolanoDePrisionesOVP" target="_blank" rel="noopener"
						class="w-9 h-9 rounded-lg bg-slate-200 dark:bg-white/10 hover:bg-blue-600 text-slate-500 dark:text-slate-400 hover:text-white flex items-center justify-center transition-colors">
						<svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
							<path
					...
					<a href="https://www.instagram.com/oveprisiones/" target="_blank" rel="noopener"
						class="w-9 h-9 rounded-lg bg-slate-200 dark:bg-white/10 hover:bg-blue-600 text-slate-500 dark:text-slate-400 hover:text-white flex items-center justify-center transition-colors">
						<svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
							<path
					...
					<a href="https://www.youtube.com/@observatoriovenezolanodepr4992" target="_blank" rel="noopener"
						class="w-9 h-9 rounded-lg bg-slate-200 dark:bg-white/10 hover:bg-blue-600 text-slate-500 dark:text-slate-400 hover:text-white flex items-center justify-center transition-colors" title="YouTube">
						<svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
			...
			<div>
				...
				<ul class="space-y-3 text-slate-500 dark:text-slate-400 text-sm">
					<li><a href="<?php echo esc_url(home_url('/nosotros')); ?>" class="hover:text-blue-600 dark:hover:text-white transition-colors">Quiénes Somos</a></li>
					<li><a href="<?php echo esc_url(home_url('/noticias')); ?>" class="hover:text-blue-600 dark:hover:text-white transition-colors">Noticias</a></li>
					<li><a href="<?php echo esc_url(home_url('/biblioteca')); ?>" class="hover:text-blue-600 dark:hover:text-white transition-colors">Informes Técnicos</a></li>
					<li><a href="<?php echo esc_url(home_url('/multimedia')); ?>" class="hover:text-blue-600 dark:hover:text-white transition-colors">Multimedia</a></li>
				</ul>
			</div>
