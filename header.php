...
<div id="page" class="site min-h-screen flex flex-col bg-ovp-light dark:bg-ovp-dark transition-colors duration-300">
	...
	<header id="masthead" class="site-header sticky top-0 z-[100] transition-all duration-300">
        <div class="mx-4 mt-4">
            <div class="container mx-auto glass-card border-white/10 px-6 py-2 flex justify-between items-center">
                <!-- Branding -->
                <div class="site-branding shrink-0">
                    <a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home" class="flex items-center gap-2 group">
                        <div class="w-8 h-8 bg-ovp-accent rounded-lg flex items-center justify-center font-black text-white text-lg group-hover:rotate-12 transition-transform">M</div>
                        <span class="text-lg font-black text-slate-900 dark:text-white tracking-tighter uppercase">Modern Blog<span class="text-ovp-accent">.</span></span>
                    </a>
                </div>
                ...
                <nav id="site-navigation" class="main-navigation hidden lg:block">
                    <div class="nav-menu">
                        ...
                        wp_nav_menu( array(
                            ...
                            'container'      => false,
                            'menu_class'     => 'flex items-center gap-8 text-[10px] font-black uppercase tracking-[0.2em] text-slate-600 dark:text-slate-400',
                            'fallback_cb'    => false,
                        ) );
                        ?>
                    </div>
